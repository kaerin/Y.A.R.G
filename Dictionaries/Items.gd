...
#	chest[PLATE] 	= {base_type = 'Armour', location = 'Chest', base_name = 'Plate', armor_class = 8, res_slash = 4, res_stab = 2, res_blunt = 4, to_hit = -2, weight = 6}
	...
	armour[G.LOC.CHEST][G.MAT.CLOTH] 	= {base_type = G.BaseType.Armour, location = G.LOC.CHEST, loc_name = 'Chest', base_name = 'Cloth', armor_class = 2, res = [[G.DmgType.Slash,4],[G.DmgType.Stab,4],[G.DmgType.Blunt,4],[G.DmgType.Fire,4]], to_hit = 0, weight = 6, img_rect = Rect2(1824,1120,32,32)}
